...
const PYTHON_BIN = process.env.WHISPER_PYTHON || '/Users/lytic/venvs/nanoclaw/bin/python3';
const TRANSCRIBE_SCRIPT = path.join(path.dirname(new URL(import.meta.url).pathname), '..', 'scripts', 'transcribe.py');
 ...
 */
export async function transcribeAudio(audioBuffer, ext = 'ogg') {
